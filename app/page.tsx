  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-7xl ">
        ...
        {/* CONTACT SECTION */}
        <section className="container mx-auto p-4 sm:p-6 my-6 flex-col justify-center items-center ">
          <div className="space-y-4 text-center py-6 relative z-10">
            <h2 className="uppercase text-lg sm:text-xl md:text-2xl font-bold">
        ...
        <section className="container  mx-auto flex-col justify-center items-center space-y-8">
          <div className="relative flex items-center justify-center md:justify-start md:px-14">
            {/* Imagem de fundo */}
            <div className="absolute top-0 left-0 w-full h-[100%] md:h-[24vw] lg:h-[14vw]">
              <Image
                src={BgCalendar}
